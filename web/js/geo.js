/**
 * Geo math for the web client — a faithful ES-module twin of GhostRaceKit's
 * Geo.swift and tools/geo.mjs. Pinned to the same shared crosscheck.json
 * fixture as the Swift implementation (see web/test/geo.test.mjs). If you
